...
export default function Hero() {
    return (
        <section id="home" className="pt-16 bg-gradient-to-b from-zinc-50 to-white dark:from-zinc-950 dark:to-zinc-900">
            <div className="max-w-6xl mx-auto px-4 py-24 grid md:grid-cols-12 gap-10 items-center">
                <div className="md:col-span-7">
                    ...
                    >
                        Hi, I’m <span className="text-blue-600 dark:text-blue-400">Amirparsa Rouhi</span> — Frontend Developer.
                    </motion.h1>
                    <p className="mt-6 text-lg text-zinc-600 dark:text-zinc-300 max-w-prose">
                        I build clean, accessible, and performant web apps. Here you’ll find a selection of my projects, my skill set,
                        and a bit about me.
                    </p>
                    <div className="mt-8 flex flex-wrap gap-3">
                        <a href={socials.github} className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-blue-600 text-white hover:bg-blue-700">View Projects <ExternalLink size={18} /></a>
                ...
                <div className="md:col-span-5">
                    <div className="aspect-[4/5] rounded-3xl overflow-hidden ring-1 ring-zinc-200 dark:ring-zinc-800">
                        <img src="https://picsum.photos/seed/headshot/800/1000" alt="Your headshot" className="w-full h-full object-cover" />
                    </div>
                </div>
            </div>
        </section>
